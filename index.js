...
let file = argv._[0];
let outputFile = !!argv._[1] ? argv._[1] : null; // take the output from args or get it from base filename
const headerFile = !!argv.h ? path.resolve(argv.h) : null; // take the output from args or get it from base filename
const footerFile = !!argv.f ? path.resolve(argv.f) : null; // take the output from args or get it from base filename
const indexFile = !!argv.i ? path.resolve(argv.i) : null; // take the output from args or get it from base filename
if (!file) {
